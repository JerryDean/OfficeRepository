...
public class SetNmsResult {
	private String status;
	private String message;
	private String timeStamp;
	private SetResultObject resultObject;
	...
	public SetResultObject getResultObject() {
		return resultObject;
	}

	public void setResultObject(SetResultObject resultObject) {
